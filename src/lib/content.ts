...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: '/images/projects/khindasi-feeder-canal.jpg',
    alt: 'Khindasi feeder canal with aqueduct and wildlife overpass structures near Ramtek',
    featured: false,
    gallery: ['/images/projects/khindasi-feeder-canal.jpg'],
    summary:
      'An irrigation feeder canal project diverting Pench dam reservoir water to Khindsi Lake, irrigating 16,000 hectares of agricultural land in Ramtek constituency - engineered with wildlife protection at its core.',
    overview:
      'The Khindsi Feeder Canal is an irrigation project that acts as a feeder canal diverting Pench dam reservoir water to Khindsi Lake and then to the Pench tailing portions, irrigating 16,000 hectares of agricultural land in the Ramtek constituency.\n\nThe project consists of a Head Regulator with 5m height dual gates monitored by high-pressure motors. It includes a 790-metre elevated aqueduct and a 380-metre cut-and-cover aqueduct. The canal alignment passes through 3 km of the Ramsinghdeo National Sanctuary forest area, necessitating 3 animal overpass structures (commonly known as aqueducts) to protect natural wildlife habitats. This project is a pure example of engineering that protects and takes care of the natural wildlife habitat.\n\nThe project also includes a 4 km open canal portion, a 5.4 km underground aqueduct, and various regulatory and cross-drainage structures along the alignment.',
    scope: [
      'Head Regulator with 5m height dual gates and high-pressure motors',
      '790m elevated aqueduct',
      '380m cut-and-cover aqueduct',
      '3 animal overpass structures through 3km Ramsinghdeo National Sanctuary forest',
      '4km open canal portion',
      '5.4km underground aqueduct',
      'Various regulatory and cross-drainage structures',
    ],
    metrics: [
      { value: '16,000 ha', label: 'Area irrigated' },
      { value: '\u20b948.62 Cr', label: 'Project value' },
      { value: 'Ongoing', label: 'Status' },
      { value: '3', label: 'Wildlife overpasses' },
    ],
  },
  {
